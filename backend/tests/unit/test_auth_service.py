...
async def test_register_success():
    ...
    body = RegisterRequest(username="test", email="test@test.com", password="12345678")
...
async def test_register_email_conflict():
    ...
    body1 = RegisterRequest(username="test", email="test@test.com", password="12345678")
    body2 = RegisterRequest(username="test1", email="test@test.com", password="gfhjjkjkhjhm")
