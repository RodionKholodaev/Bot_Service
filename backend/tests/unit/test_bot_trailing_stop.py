...
интерфейса его убрали, а не дотянули до бэкенда, потому что осмысленных дистанции и
порога у нас нет: freqtrade делит их на плечо, и при x10 трейлинг взводился бы почти
сразу, обрезая каждый выигрыш вместо заданного take-profit и оставляя убытки
полноразмерными.
