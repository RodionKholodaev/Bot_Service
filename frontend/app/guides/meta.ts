...
export const GUIDES: GuideMeta[] = [
  {
    ...
    category: 'start',
    readMinutes: 5,
    keywords: ['начало', 'основы', 'что это', 'принцип работы', 'новичок', 'freqtrade'],
  },
  {
    ...
    category: 'start',
    readMinutes: 7,
    keywords: ['ключ', 'api', 'bybit', 'биржа', 'безопасность', 'права', 'подключить'],
  },
  {
    slug: 'pervyj-bot',
    ...
    category: 'create',
    readMinutes: 9,
    keywords: ['создать', 'первый бот', 'мастер', 'депозит', 'пара', 'плечо', 'настройка'],
  },
  {
    slug: 'strategii',
    ...
    category: 'create',
    readMinutes: 10,
    keywords: ['стратегия', 'rsi', 'cci', 'индикаторы', 'пресет', 'консервативная', 'агрессивная', 'фильтры'],
  },
  {
    ...
    category: 'create',
    readMinutes: 7,
    keywords: ['тейк профит', 'стоп лосс', 'tp', 'sl', 'убыток', 'прибыль', 'выход из сделки', 'ликвидация'],
  },
  {
    ...
    category: 'create',
    readMinutes: 6,
    keywords: ['демо', 'dry run', 'симуляция', 'боевой режим', 'реальные деньги', 'тест'],
  },
  {
    ...
    category: 'manage',
    readMinutes: 6,
    keywords: ['запустить', 'остановить', 'удалить', 'статус', 'ошибка', 'логи', 'управление'],
  },
  {
    ...
    category: 'manage',
    readMinutes: 8,
    keywords: ['статистика', 'график', 'винрейт', 'просадка', 'pnl', 'прибыль', 'сделки', 'отчёт'],
  },
  {
    ...
    category: 'money',
    readMinutes: 6,
    keywords: ['комиссия', 'баланс', 'оплата', 'пополнить', 'деньги', 'рубли', 'тариф', 'списание'],
  },
  {
    ...
    category: 'faq',
    readMinutes: 8,
    keywords: ['проблема', 'не работает', 'ошибка', 'вопрос', 'помощь', 'нет сделок', 'faq'],
  },
];
