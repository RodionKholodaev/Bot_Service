...
Жёсткий лимит на пользователя уже есть: 10 запросов в минуту и 100 в сутки,
константы в `services/assistant/rate_limit.py`. Поменять — правка двух строк,
миграция не нужна. Подробности и обоснование — в
[backend.md](backend.md#rate-limit).
